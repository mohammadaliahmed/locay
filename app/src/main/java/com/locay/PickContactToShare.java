...
public class PickContactToShare extends AppCompatActivity {
     FirebaseAnalytics mFirebaseAnalytics;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pick_contact_to_share);
 ...
 Bundle bundle = new Bundle();
        ...
        ArrayList<Android_Contact> arrayList = doSomething(getApplicationContext());
        ...
        ListView buckyAdapter = (ListView) findViewById(R.id.contactslist);
    ...
    public ArrayList<Android_Contact> doSomething(Context context) {
